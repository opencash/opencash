...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::opencash::core::Account >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::opencash::core::Account >
  {
    public:
    typedef ::opencash::core::Account object_type;
    typedef ::std::shared_ptr< ::opencash::core::Account > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::opencash::core::Account, id_sqlite, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::opencash::core::Account, id_sqlite, A >::name_type_
  pointer_query_columns< ::opencash::core::Account, id_sqlite, A >::
  name (A::table_name, "\"name\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::opencash::core::Account, id_sqlite, A >::descr_type_
  pointer_query_columns< ::opencash::core::Account, id_sqlite, A >::
  descr (A::table_name, "\"descr\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::opencash::core::Account, id_sqlite, A >::type_type_
  pointer_query_columns< ::opencash::core::Account, id_sqlite, A >::
  type (A::table_name, "\"type\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::opencash::core::Account, id_sqlite, A >::parent_type_
  pointer_query_columns< ::opencash::core::Account, id_sqlite, A >::
  parent (A::table_name, "\"parent\"", 0);

  template <>
  class access::object_traits_impl< ::opencash::core::Account, id_sqlite >:
    public access::object_traits< ::opencash::core::Account >
  {
    public:
    ...
    struct children_traits
    {
      ...
      typedef ::opencash::core::Account::WeakAccounts container_type;
      typedef
  ...
  template <>
  class access::object_traits_impl< ::opencash::core::Account, id_common >:
    public access::object_traits_impl< ::opencash::core::Account, id_sqlite >
  {
  };
  ...
  template <>
  struct query_columns_base< ::opencash::core::Account, id_sqlite >
  {
    // parent
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::opencash::core::Account, id_sqlite, A >:
    query_columns_base< ::opencash::core::Account, id_sqlite >,
  ...
  template <typename A>
  const typename query_columns< ::opencash::core::Account, id_sqlite, A >::name_type_
  query_columns< ::opencash::core::Account, id_sqlite, A >::
  name (A::table_name, "\"name\"", 0);

  template <typename A>
  const typename query_columns< ::opencash::core::Account, id_sqlite, A >::descr_type_
  query_columns< ::opencash::core::Account, id_sqlite, A >::
  descr (A::table_name, "\"descr\"", 0);

  template <typename A>
  const typename query_columns< ::opencash::core::Account, id_sqlite, A >::type_type_
  query_columns< ::opencash::core::Account, id_sqlite, A >::
  type (A::table_name, "\"type\"", 0);

  template <typename A>
  const typename query_columns< ::opencash::core::Account, id_sqlite, A >::parent_type_
  query_columns< ::opencash::core::Account, id_sqlite, A >::
  parent (A::table_name, "\"parent\"", 0);
}
