...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::opencash::model::Split >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::opencash::model::Split >
  {
    public:
    typedef ::opencash::model::Split object_type;
    typedef ::std::shared_ptr< ::opencash::model::Split > pointer_type;
...
namespace odb
{
  ...
  template <typename A>
  const typename pointer_query_columns< ::opencash::model::Split, id_sqlite, A >::account_type_
  pointer_query_columns< ::opencash::model::Split, id_sqlite, A >::
  account (A::table_name, "\"account\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::opencash::model::Split, id_sqlite, A >::memo_type_
  pointer_query_columns< ::opencash::model::Split, id_sqlite, A >::
  memo (A::table_name, "\"memo\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::opencash::model::Split, id_sqlite, A >::action_type_
  pointer_query_columns< ::opencash::model::Split, id_sqlite, A >::
  action (A::table_name, "\"action\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::opencash::model::Split, id_sqlite, A >::value_type_
  pointer_query_columns< ::opencash::model::Split, id_sqlite, A >::
  value (A::table_name, "\"value\"", 0);

  template <>
  class access::object_traits_impl< ::opencash::model::Split, id_sqlite >:
  ...
  template <>
  class access::object_traits_impl< ::opencash::model::Split, id_common >:
    public access::object_traits_impl< ::opencash::model::Split, id_sqlite >
  {
  };
  ...
  template <>
  struct query_columns_base< ::opencash::model::Split, id_sqlite >
  {
    // transaction
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::opencash::model::Split, id_sqlite, A >::account_type_
  query_columns< ::opencash::model::Split, id_sqlite, A >::
  account (A::table_name, "\"account\"", 0);

  template <typename A>
  const typename query_columns< ::opencash::model::Split, id_sqlite, A >::memo_type_
  query_columns< ::opencash::model::Split, id_sqlite, A >::
  memo (A::table_name, "\"memo\"", 0);

  template <typename A>
  const typename query_columns< ::opencash::model::Split, id_sqlite, A >::action_type_
  query_columns< ::opencash::model::Split, id_sqlite, A >::
  action (A::table_name, "\"action\"", 0);

  template <typename A>
  const typename query_columns< ::opencash::model::Split, id_sqlite, A >::value_type_
  query_columns< ::opencash::model::Split, id_sqlite, A >::
  value (A::table_name, "\"value\"", 0);
}

#include <generated/Split-odb.ixx>
